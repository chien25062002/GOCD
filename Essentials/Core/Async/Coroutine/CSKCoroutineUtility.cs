...
namespace CodeSketch.Core.Async
{
    ...
    /// (<see cref="CSKCoroutineGlobal"/>), allowing coroutine usage without directly
    /// accessing any <see cref="MonoBehaviour"/>.
    /// </summary>
    public static class CSKCoroutineUtility
    {
        // =====================================================
        // BASIC COROUTINE
        // =====================================================
        ...
        {
            return CSKCoroutineGlobal.Run(routine);
        }
        ...
        {
            CSKCoroutineGlobal.Stop(coroutine);
        }
        ...
        {
            CSKCoroutineGlobal.RunAfter(new WaitForEndOfFrame(), action);
        }
        ...
        {
            CSKCoroutineGlobal.RunAfter(new WaitForFixedUpdate(), action);
        }
        ...
        {
            CSKCoroutineGlobal.RunAfter(new WaitForSeconds(seconds), action);
        }
        ...
        {
            CSKCoroutineGlobal.RunAfter(new WaitForSecondsRealtime(seconds), action);
        }
        ...
        public static void WaitUntil(Func<bool> predicate, Action action)
        {
            ...
            CSKCoroutineGlobal.RunAfter(new WaitUntil(predicate), action);
        }
    }
}
