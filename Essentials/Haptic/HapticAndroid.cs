...
namespace CodeSketch.Haptic
{
    ...
    public static class HapticAndroid
    {
        ...
        static bool _isSupportVibrationEffect { get { return _apiLevel >= 26; } }
        ...
        public static void Init()
        {
            ...
            CodeSketchDebug.LogRuntime(typeof(HapticAndroid), $"Initialized" +
        ...
        public static void Vibrate(HapticType type)
        {
            switch (type)
            {
                ...
                default:
                    CodeSketchDebug.Log(typeof(HapticAndroid), $"Undefined vibration type {type}");
                    break;
            }
        }
        ...
        public static void Vibrate(long[] pattern, int[] amplitudes = null, int repeat = -1, bool cancel = false)
        {
            ...
            {
                CodeSketchDebug.LogWarning(typeof(HapticAndroid), "Length of Amplitudes array is not equal to Pattern array. Amplitudes will be ignored.");
