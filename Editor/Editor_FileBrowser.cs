...
{
    public static class Editor_FileBrowser
    {
        static bool IsMacOS => SystemInfo.operatingSystem.IndexOf("Mac OS", StringComparison.Ordinal) != -1;

        static bool IsWinOS => SystemInfo.operatingSystem.IndexOf("Windows", StringComparison.Ordinal) != -1;
