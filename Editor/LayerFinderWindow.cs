...
{
    public class LayerFinderWindow : EditorWindow
    {
        private string layerToSearch = "Default";
        private List<GameObject> foundObjects = new List<GameObject>();
        private ReorderableList reorderableList;
        private Vector2 scrollPos;

        [MenuItem("Tools/Layer Finder")]
        public static void ShowWindow()
        {
            GetWindow<LayerFinderWindow>("Layer Finder");
        }
        ...
        private void FindGameObjectsWithLayer()
        {
            foundObjects.Clear();
        ...
        private void FindLayeredChildren(Transform parent, int layer)
        {
