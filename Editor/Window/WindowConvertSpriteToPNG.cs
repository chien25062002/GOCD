...
{
    public class WindowConvertSpriteToPNG : EditorWindow
    {
        List<Sprite> spriteList = new(); // Danh sách Sprite
        string savePath = "Assets"; // Đường dẫn lưu mặc định

        [MenuItem("Tools/Window/Convert Sprite To PNG")]
        public static void ShowWindow()
        {
            GetWindow<WindowConvertSpriteToPNG>("Sprite to PNG");
        }
