...
namespace GOCD.Framework
{
    ...
    public class TextAnimation
    {
        ...
        public void Apply(UI_TextBase_Floating textBase, Sequence sequence)
        {
        ...
        public void ApplyPrime(UI_TextBase_Floating textBase, PrimeTween.Sequence sequence)
        {
            float animDuration = textBase.liveTime * (_durationRage.y - _durationRage.x);
            float animDelay = textBase.liveTime * _durationRage.x;
        ...
        protected virtual Tween GetTween(UI_TextBase_Floating textBase, float duration)
        {
            return null;
        }

        protected virtual  PrimeTween.Tween GetPrimeTween(UI_TextBase_Floating textbase, float duration)
        {
            return default;
        }
    }
