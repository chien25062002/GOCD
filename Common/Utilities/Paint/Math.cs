...
namespace CFramework.Paint
{
    ...
    {
        // Ngưỡng sai số cho phép chấp nhận
        ...
        /// Hàm này kiểm tra xem liệu một điểm p trong không gian có nằm trên một mặt phẳng tạo bởi 3 đỉnh hay không
        /// Đầu tiên là tính 2 vector tạo từ 3 điểm và chung gốc đỉnh t1, tìm vector pháp tuyến của mặt phẳng bằng cách sử dụng Vector3.Cross (Tích có hướng)
        /// Sẽ tạo ra vector vuông góc với 2 vector đó
        /// Nếu một điểm nằm trên mặt phẳng, thì khi chiếu vào vector normal của mặt phẳng tại đỉnh t1 thì giá trị của nó phải sát với TOLERANCE, nếu không nó đang nằm ngooài mặt phẳng
